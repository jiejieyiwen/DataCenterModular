...
type PublicConfig struct {
	...
	EurekaURL  string `yml:"EurekaURL" json:"EurekaURL"`
}

type DataUrlConfig struct {
	DataURL      string `yml:"DataURL" json:"DataURL"`
	AuthURL      string `yml:"AuthURL" json:"AuthURL"`
	DataUserName string `yaml:"DataUserName" json:"DataUserName"`
	DataPassWord string `yaml:"DataPassWord" json:"DataPassWord"`
